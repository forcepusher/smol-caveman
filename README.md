...
- AI is inherently infected by a Dunning-Kruger effect as well and we have to fight that. Next couple of lines are to maximize tool usage, so it doesn't assume things and concentrates on quality.
