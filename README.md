...
- Next couple of lines are to maximize tool usage, so it doesn't assume things and concentrates on quality. AI is inherently infected by a Dunning-Kruger effect and we have to fight that.
